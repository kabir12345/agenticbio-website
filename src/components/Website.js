    ...
    <div className="min-h-screen text-gray-900" 
      ...
      <div className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-2xl text-left mt-8 max-w-3xl" style={{ color: '#EE9A78' }}>
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row gap-12">
          <div className="md:w-1/3">
            <h2 className="text-3xl font-bold mb-4 text-left" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Our Team</h2>
            <p className="text-gray-600 text-left">Building the future of AI systems.</p>
          </div>
              ...
              <div key={member.name} className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm flex flex-col md:flex-row gap-6">
                ...
                <div className="md:w-2/3">
                  <div className="flex items-center gap-3 mb-1">
                    <h3 className="text-xl font-bold" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>{member.name}</h3>
                    {member.linkedin && (
                      <a 
